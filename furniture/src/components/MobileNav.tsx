          ...
          >
            ...
            <div className="p-6 flex items-center justify-between border-b border-border/20 relative z-10">
              <Link
                to="/"
                onClick={onClose}
                className="text-xl font-black italic tracking-tighter bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent"
              >
                LEONOR.
              </Link>
              <Button
            ...
            <div className="flex-1 overflow-y-auto py-10 px-8 space-y-2 relative z-10 custom-scrollbar">
              <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground font-black mb-6 opacity-60">
                Menu
              </p>
              {navItems.map((item) => (
                        ...
                        <div
                          className={cn(
                            ...
                            isActive
                              ...
                              : "bg-background border border-border/40 group-hover:scale-110",
                          )}
                        >
                          <item.icon
                            size={20}
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col min-w-0">
                        <span className="font-bold truncate text-foreground leading-none mb-1">
                          {session.user.name}
                        </span>
